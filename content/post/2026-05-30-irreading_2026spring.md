---
title: "IR Reading 2026春（オンライン） 開催案内"
date: 2026-04-23T16:30:00+09:00
etitle: "IR Reading 2026Spring (Online)"
subtitle: "2026年5月30日"
tags: ["news", "イベント"]
draft: false
---
...
## 概要
情報アクセス分野に関する主要国際会議（SIGIRやWSDMなど）の論文読み合わせを行うIR Readingを**オンライン**にて開催します．多人数で協力しあって論文を紹介しあうことで，論文への理解を深めたり，分野全体のトレンドを掴んだりする場となれば幸いです．これまでの勉強会の内容につきましては，[過去のページ](https://sigirtokyo.github.io/post/2025-11-15-irreading_2025fall/)をご覧ください．
...
## 対象会議
IR Reading 2026春 では2025年11月〜2026年6月頃に開催された，ACM SIGIRが主催・共催している国際会議を主に対象とします．
下記以外でも，情報検索に関連する会議・論文であれば何でも結構です．

- [TheWebConf 2026](https://www2026.thewebconf.org/)
- [ECIR 2026](https://ecir2026.eu/)
- [WSDM 2026](https://www.wsdm-conference.org/2026/)
- [CHIIR 2026](https://chiir2026.github.io/)
...
### 2. セッションor論文情報の登録 （5月20日（水） 締切）

Slackに参加後，本勉強会用チャンネル（#2026spring）に情報を登録するためのGoogle SpreadsheetのURLがSlackに記載されていますので，そちらのURLから氏名，所属，担当したいセッション（または論文）をご登録ください．発表したい論文が被った場合は，該当者と相談して調整ください．基本は早い者勝ちです．

### 3. 聴講での参加登録（5月29日（金）締切）

Slackに参加後，本勉強会用チャンネル（#2026spring）に情報を登録するためのGoogle SpreadsheetのURLがSlackに記載されていますので，そちらのURLから氏名と所属を聴講者の欄に記入してください．

### 4. 発表資料の登録（5月29日（金） 締切）
...
Zoomの接続情報をSlackの#2026springチャンネルにて通知いたしますので，そちらから参加ください．
...
## 連絡先 - ACM SIGIR 東京支部
   ...
   - 担当: 大島 裕明（兵庫県立大学） 佃 洸摂（産業技術総合研究所）